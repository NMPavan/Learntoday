...
public class TrainAuthController {
	...
	@PostMapping("/signin")
	public ResponseEntity<com.example.LearnToday.payload.JwtAuthResponse> authenticateUser(@RequestBody Trainer trainer){
	...
	@PostMapping("/signup")
	public ResponseEntity<String> signupUser(@RequestBody Trainer signupDto){
		...
		com.example.LearnToday.Entity.Role roles = roleRepo.findByName("ROLE_TRAINER").get();
